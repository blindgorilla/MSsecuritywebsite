...
const licences = [
  {
    name: "Maritime Security Operating Licence",
    category: "Operating Licence",
    authority: "Cyprus Department of Merchant Shipping",
    status: "Active",
    issueDate: "January 2020",
    expiryDate: "January 2027",
    jurisdiction: "Cyprus / EU",
    description: "Primary operating licence for maritime security services within EU waters and international shipping lanes.",
  },
  {
    ...
    description: "Quality management system certification demonstrating commitment to consistent service delivery.",
  },
  {
    ...
    jurisdiction: "International",
    description: "Supply chain security management systems certification for maritime security operations.",
  },
  {
    name: "Corporate Registration Certificate",
    category: "Company Registration",
    authority: "Cyprus Registrar of Companies",
    status: "Active",
    issueDate: "September 1986",
    expiryDate: "N/A",
    jurisdiction: "Cyprus",
    description: "Official company registration and incorporation documentation.",
  },
  {
    name: "Professional Indemnity Insurance",
    category: "Insurance",
    authority: "Lloyd's of London",
    status: "Active",
    issueDate: "January 2026",
    expiryDate: "January 2027",
    jurisdiction: "International",
    description: "Comprehensive professional indemnity and liability insurance coverage.",
  },
  {
    name: "STCW Training Accreditation",
    category: "Training Accreditation",
    authority: "Maritime Training Institute",
    status: "Active",
    issueDate: "February 2024",
    expiryDate: "February 2027",
    jurisdiction: "International",
    description: "Accreditation for Standards of Training, Certification and Watchkeeping compliance.",
  },
  {
    name: "ISPS Code Compliance Certificate",
    ...
    expiryDate: "May 2028",
    jurisdiction: "International",
    description: "International Ship and Port Facility Security Code compliance verification.",
  },
  {
    name: "BIMCO Membership",
    category: "Industry Membership",
    authority: "Baltic and International Maritime Council",
    status: "Active",
    issueDate: "January 2015",
    expiryDate: "December 2026",
    jurisdiction: "International",
    description: "Membership in the world's largest international shipping association.",
  },
];
...
const policies = [
  ...
  },
  {
    ...
    description: "Terms governing use of our services and website.",
  },
  {
  ...
  },
  {
    ...
    description: "Our commitment to workplace health and safety standards.",
  },
  {
    title: "Quality Policy",
    description: "Quality management principles and service standards.",
  },
  {
    title: "Anti-Bribery & Ethics Policy",
    description: "Ethical conduct and anti-corruption guidelines.",
  },
  {
    title: "Complaints Procedure",
    description: "Process for submitting and resolving complaints.",
  },
  {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <section className="bg-slate-50 py-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mb-12 text-center">
            <div className="text-sm font-semibold uppercase tracking-wide text-[#0369A1]">Documentation</div>
            <h2 className="mt-4 text-3xl font-semibold text-slate-900 md:text-4xl">Licences & Certifications</h2>
            <p className="mx-auto mt-4 max-w-2xl text-slate-600">
              Official licences, certifications, and accreditations held by MS Security Group entities.
            </p>
          </div>

          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {licences.map((licence) => (
              <Card key={licence.name} className="border-slate-200 bg-white">
                <CardContent className="p-6">
                  <div className="flex items-start justify-between">
                    <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#0369A1]/10">
                      <FileCheck className="h-5 w-5 text-[#0369A1]" />
                    </div>
                  ...
                  <h3 className="mt-4 font-semibold text-slate-900">{licence.name}</h3>
                  <p className="mt-1 text-xs font-medium text-[#0369A1]">{licence.category}</p>
                  
                  <p className="mt-3 text-sm text-slate-600">{licence.description}</p>
                  ...
                  <div className="mt-4 space-y-2 text-xs text-slate-500">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {licence.issueDate} - {licence.expiryDate}
                    </div>
                  </div>
                  ...
                  <Button 
                    variant="outline" 
                    size="sm" 
                    className="mt-4 w-full rounded-lg border-slate-300 text-slate-700 hover:bg-slate-50"
                  >
                    View PDF
      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mb-12 text-center">
            <div className="text-sm font-semibold uppercase tracking-wide text-[#0369A1]">Legal</div>
            <h2 className="mt-4 text-3xl font-semibold text-slate-900 md:text-4xl">Policies & Procedures</h2>
            <p className="mx-auto mt-4 max-w-2xl text-slate-600">
              Corporate policies governing our operations, data handling, and business conduct.
            </p>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {policies.map((policy) => (
              <div
                key={policy.title}
                className="flex items-center justify-between rounded-lg border border-slate-200 bg-slate-50 p-4 transition-colors hover:border-[#0369A1]/30 hover:bg-slate-100"
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-medium text-slate-900">{policy.title}</h3>
                    <p className="text-sm text-slate-500">{policy.description}</p>
                  </div>
                </div>
                <Button variant="ghost" size="sm" className="text-[#0369A1] hover:text-[#0284C7]">
                  Read
